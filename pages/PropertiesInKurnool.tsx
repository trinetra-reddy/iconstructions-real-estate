...
export const PropertiesInKurnool: React.FC = () => {
  const kurnoolProjects = PROJECTS.filter(p =>
    ...
    <Layout>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
              Explore RERA approved properties in Kurnool - Andhra Pradesh's judicial capital with excellent growth potential.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-dark mb-6">
              Why Invest in <span className="italic text-brand-primary">Kurnool?</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: <MapPin className="w-8 h-8" />, title: 'Strategic Location', description: 'Gateway to Rayalaseema region' },
              { icon: <TrendingUp className="w-8 h-8" />, title: 'Growth Potential', description: '10-12% annual appreciation' },
              { icon: <Building2 className="w-8 h-8" />, title: 'Infrastructure', description: 'Smart City development underway' },
              { icon: <Star className="w-8 h-8" />, title: 'Affordability', description: 'Best prices in Andhra Pradesh' }
            ].map((item, index) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-dark mb-6">
              Our Projects in <span className="italic text-brand-primary">Kurnool</span>
            </h2>
          </div>

          {kurnoolProjects.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {kurnoolProjects.map((project) => (
                <ProjectCard key={project.id} project={project} />
              ))}
            </div>
          ) : (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg mb-6">We're expanding to Kurnool soon. Contact us for upcoming projects.</p>
      ...
      <section className="py-20 bg-gradient-to-br from-brand-dark to-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">
            Interested in <span className="italic text-brand-primary">Kurnool Properties?</span>
          </h2>
          <p className="text-gray-300 text-lg mb-10">
            Contact us for expert guidance on Kurnool real estate investments.
          </p>
